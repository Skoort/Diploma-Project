...
function collageFace = MergeSmooth(OBJs, splicedFace, numRegions, regionByIndex, indicesByRegion, chosenFaces, chosenFacesByRegion, shouldAverageWeights)
    ...
    for i = 1:numRegions
        ...
        while 1
            ...
            for j = 1:length(innerVerts)
                ...
                s_ = min_dist_ / (max_dist_ * 2);  % Ta parameter je pomemben. Napisi v overleaf. This is the smoothing factor for this vertex's region. 
