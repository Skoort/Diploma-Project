...
colorPerRegion = distinguishable_colors(16);

face1.VertexRGB = repmat([0xff, 0xdb, 0xac] / 255, face1.nVertices, 1);

for i = 1:numRegions
    %face1.VertexRGB(indicesByRegion{i}, :) = repmat([i / 16, 0, 0], length(indicesByRegion{i}), 1);
    face1.VertexRGB(indicesByRegion{i}, :) = repmat(colorPerRegion(i, :), length(indicesByRegion{i}), 1);
end
...
saveas(v1.Figure, 'ShowAllRegions.png');
