function [mesh_out] = MeshFit2(mesh_in)
    ...
    Floating = shape3D;
    Floating.importWavefront('template.obj', 'Data/');
    ...
    forRM.TargetShape = clone(mesh_in);
    ...
    forNRM.TargetShape = clone(mesh_in);%Target;
    forNRM.map()

    mesh_out = clone(forNRM.FloatingShape);
